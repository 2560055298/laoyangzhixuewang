package com.yyy.msmservice.service.impl;

import com.yyy.servicebase.exceptionhandler.GuiguException;
import com.yyy.msmservice.service.MesService;
import com.yyy.msmservice.utils.RandomUtil;
...
public class MesServiceImpl implements MesService {
    ...
    public boolean tencentMessageApi(String phone, String fourBitRandom){
        try {
            Credential cred = new Credential("腾讯短信SecretId", "腾讯短信SecretKey");
